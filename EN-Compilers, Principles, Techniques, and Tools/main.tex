...
\begin{figure}[htbp]
    ...
    \begin{minipage}{\linewidth}
        \centering
        \begin{tikzpicture}
            \node (root) at (0,0) {\textit{stmt}};
            \node (if1) at (-2,-0.95) {\textbf{if}};
            \node (expr1) at (-0.75,-1) {\textit{expr}};
            \node (then1) at (0.75,-0.95) {\textbf{then}};
            \node (stmt1) at (2.25,-1) {\textit{stmt}};
            \draw (root.south west) to (if1.north east);
            \draw ($(root.south west)!0.25!(root.south east)$) to (expr1.north);
            \draw ($(root.south east)!0.25!(root.south west)$) to (then1.north);
            \draw (root.south east) to (stmt1.north west);
            \draw ($(expr1.south west)!0.25!(expr1.south east)$) to (-1.25,-1.5);
            \draw ($(expr1.south east)!0.25!(expr1.south west)$) to (-0.25,-1.5);
            \draw (-1.25,-1.5) to (-0.25,-1.5);
            \node[anchor=north] (L1) at (-0.75,-1.5) {$E_1$};
            \node (if2) at (0.25,-1.95) {\textbf{if}};
            \node (expr2) at (1.5,-2) {\textit{expr}};
            \node (then2) at (3,-1.95) {\textbf{then}};
            \node (stmt2) at (4.5,-2) {\textit{stmt}};
            \node (else2) at (6,-1.95) {\textbf{else}};
            \node (stmt3) at (7.5,-2) {\textit{stmt}};
            \draw (stmt1.south west) to (if2.north east);
            \draw ($(stmt1.south west)!0.25!(stmt1.south east)$) to (expr2.north);
            \draw ($(stmt1.south east)!0.25!(stmt1.south west)$) to (then2.north);
            \draw (stmt1.south east) to (stmt2.north west);
            \draw ($(stmt1.south east)!0.25!(stmt1.north east)$) to (else2.north west);
            \draw (stmt1.east) to (stmt3.north west);
            \draw ($(expr2.south west)!0.25!(expr2.south east)$) to (1,-2.5);
            \draw ($(expr2.south east)!0.25!(expr2.south west)$) to (2,-2.5);
            \draw (1,-2.5) to (2,-2.5);
            \node[anchor=north] (L2) at (1.5,-2.5) {$E_2$};
            \draw ($(stmt2.south west)!0.25!(stmt2.south east)$) to (4,-2.5);
            \draw ($(stmt2.south east)!0.25!(stmt2.south west)$) to (5,-2.5);
            \draw (4,-2.5) to (5,-2.5);
            \node[anchor=north] (S1) at (4.5,-2.5) {$S_1$};
            \draw ($(stmt3.south west)!0.25!(stmt3.south east)$) to (7,-2.5);
            \draw ($(stmt3.south east)!0.25!(stmt3.south west)$) to (8,-2.5);
            \draw (7,-2.5) to (8,-2.5);
            \node[anchor=north] (S2) at (7.5,-2.5) {$S_2$};
        \end{tikzpicture}
    \end{minipage}
    \begin{minipage}{\linewidth}
        \centering
        \begin{tikzpicture}
            ...
            \node (then1) at (0.75,-0.95) {\textbf{then}};
            \node (stmt1) at (2.25,-1) {\textit{stmt}};
            \node (else1) at (3.75,-0.95) {\textbf{else}};
            \node (stmt11) at (5.25,-1) {\textit{stmt}};
            \draw (root.south west) to (if1.north east);
            \draw ($(root.south west)!0.25!(root.south east)$) to (expr1.north);
            \draw ($(root.south east)!0.25!(root.south west)$) to (then1.north);
            \draw (root.south east) to (stmt1.north west);
            \draw ($(root.south east)!0.25!(root.north east)$) to (else1.north west);
            \draw (root.east) to (stmt11.north west);
            \draw ($(expr1.south west)!0.25!(expr1.south east)$) to (-1.25,-1.5);
            \draw ($(expr1.south east)!0.25!(expr1.south west)$) to (-0.25,-1.5);
            \draw (-1.25,-1.5) to (-0.25,-1.5);
            \node[anchor=north] (L1) at (-0.75,-1.5) {$E_1$};
            \draw ($(stmt11.south west)!0.25!(stmt11.south east)$) to (4.75,-1.5);
            \draw ($(stmt11.south east)!0.25!(stmt11.south west)$) to (5.75,-1.5);
            \draw (4.75,-1.5) to (5.75,-1.5);
            \node[anchor=north] (S2) at (5.25,-1.5) {$S_2$};
            \node (if2) at (0.25,-1.95) {\textbf{if}};
            \node (expr2) at (1.5,-2) {\textit{expr}};
            \node (then2) at (3,-1.95) {\textbf{then}};
            \node (stmt2) at (4.5,-2) {\textit{stmt}};
        ...
        \end{tikzpicture}
    \end{minipage}
    \caption{Two parse trees for an ambiguous sentence}
    \label{Figure:4.9}
\end{figure}
